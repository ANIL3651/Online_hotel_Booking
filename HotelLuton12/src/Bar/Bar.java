...
public class Bar extends JFrame implements ItemListener, FocusListener, KeyListener {
	...
	public Bar() {
		...
		pnlHead.setBounds(10, 0, 1051, 385);
...
//		txtQuantity.addFocusListener(this);
		...
		btnAdd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				libsRes.setDate(txtDate.getText());
				libsRes.setQuantity(Integer.parseInt(txtQuantity.getText()));
				libsRes.setBookingId(Integer.parseInt(txtBookingId.getText()));
				boolean result = jdbcRes.insertRestaurant(libsRes);
				if (result == true) {
					JOptionPane.showMessageDialog(null, "Successfully add item !!");
	...
	public void showMenuItem() {
		...
		arrayListRes = jdbcBar.getMenuItem();
