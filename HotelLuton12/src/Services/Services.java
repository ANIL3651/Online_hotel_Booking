...
public class Services extends JFrame implements ItemListener {
	...
	public Services() {
		...
		pnlHead.setBounds(10, 0, 1051, 392);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		lblNewLabel.setBounds(413, 275, 95, 35);
		pnlHead.add(lblNewLabel);

		lblPrice = new JLabel("Price :");
		lblPrice.setFont(new Font("Tahoma", Font.PLAIN, 20));
		lblPrice.setBounds(21, 328, 129, 35);
		...
		txtPrice.setBounds(175, 330, 201, 35);
		...
		btnAdd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (result == true) {
					...
					Object obj[] = { txtBookingId.getText(), cmbRoom.getSelectedItem().toString(),
							txtCustomerName.getText(), txtDate.getText(), cmbServicesType.getSelectedItem().toString(),
							cmbServices.getSelectedItem().toString(), txtPrice.getText() };
					dtm.addRow(obj);
				} else {
		...
		btnAdd.setBounds(757, 350, 122, 35);
		pnlHead.add(btnAdd);
		...
		btnClear.setBounds(905, 350, 122, 35);
		pnlHead.add(btnClear);

	

		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(10, 396, 1051, 307);
